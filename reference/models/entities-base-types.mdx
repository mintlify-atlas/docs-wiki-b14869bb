...
- `IHasExtraProperties` — an `ExtraPropertyDictionary ExtraProperties` bucket initialised with `SetDefaultsForExtraProperties()` so that the [object-extension manager](/framework/extensibility/object-extension-manager) can attach declarations.
...
- [`Volo.Abp.Domain` package](/framework/ddd/volo-abp-ddd-domain)
- [Auditing flow](/flows/auditing-flow)
- [Object Extension Manager](/framework/extensibility/object-extension-manager)
