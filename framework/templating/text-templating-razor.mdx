...
- [Localization](/framework/cross/multi-lingual-objects) — `IStringLocalizer`, resource resolution, the source of `@Localizer["..."]`.
- [Dependency injection](/framework/di/abp-autofac) — how the scoped `ServiceProvider` exposed to templates is built.
