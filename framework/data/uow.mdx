...
- [Volo.Abp.Data](./volo-abp-data) — connection strings, seeding and data filters that the UoW transports.
- [Object Extending](./object-extending) — the extra-property model whose validators run inside the UoW commit path.
- [Threading](./threading) — `ICancellationTokenProvider`, ambient scope provider, and how `AsyncLocal` mirrors the UoW pattern.
