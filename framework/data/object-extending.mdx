...
- [Object Mapping](./object-mapping) — `IObjectMapper`, the generic interface the AutoMapper profile uses.
- [AutoMapper integration](./automapper) — `mapping.MapExtraProperties()` and AutoMapper-specific helpers.
- [Volo.Abp.Data](./volo-abp-data) — `IDataFilter` and the data module on which this one depends.
