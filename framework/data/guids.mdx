...
- [Timing](./timing) — `IClock.UtcNow` and how time normalization interacts with GUID generation.
- [Volo.Abp.Data](./volo-abp-data) — the data module that depends on aggregate-root IDs being available.
