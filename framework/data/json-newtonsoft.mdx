...
- [System.Text.Json adapter](./json-systemtextjson) — the default; same contract, different machinery.
- [Volo.Abp.Json](./json) — the contract this module implements.
- [Timing](./timing) — `IClock.Normalize` and `[DisableDateTimeNormalization]`.
