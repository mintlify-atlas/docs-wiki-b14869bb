...
`AbpAutoMapperExtensibleDtoExtensions.MapExtraProperties` integrates the [Object Extending](./object-extending) catalogue with AutoMapper:
...
- [Object Mapping](./object-mapping) — the abstraction this module plugs into.
- [Object Extending](./object-extending) — defines the catalogue that `MapExtraProperties` consults.
