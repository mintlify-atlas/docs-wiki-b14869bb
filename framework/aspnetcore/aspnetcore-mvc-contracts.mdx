...
| `ExtensionPropertyDto` and friends | DTOs | Reify the [object-extension](/framework/ddd/entities-and-aggregates) model |
...
- [Object extending](/framework/ddd/entities-and-aggregates) — the source
  model the extension DTOs reify.
- [Settings](/framework/cross/settings) — only settings with
