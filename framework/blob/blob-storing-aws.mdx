...
Compared to [Azure's normalizer](/framework/blob/blob-storing-azure#azureblobnamingnormalizer), the AWS one:
...
- [Volo.Abp.BlobStoring.Minio](/framework/blob/blob-storing-minio) — uses the same S3 API surface with simpler auth.
