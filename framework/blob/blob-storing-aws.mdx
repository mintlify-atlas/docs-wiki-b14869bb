...
Compared to [Azure's normalizer](blob-storing-azure#azureblobnamingnormalizer), the AWS one:
...
- [Volo.Abp.BlobStoring.Minio](blob-storing-minio) — uses the same S3 API surface with simpler auth.
