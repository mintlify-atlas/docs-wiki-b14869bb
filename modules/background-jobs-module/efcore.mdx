...
* [Domain layer](/modules/background-jobs-module/domain) — aggregate, repository contract, store.
* [MongoDB provider](/modules/background-jobs-module/mongodb) — document layout, indexing gaps.
