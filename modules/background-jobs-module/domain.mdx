...
* [Overview](./overview) — the big picture and pipeline.
* [EF Core provider](./efcore) — column types, indexes, EF query shape.
* [MongoDB provider](./mongodb) — collection shape and indexing recommendations.
...
* [Object extensions](/framework/infrastructure/object-extensions) — adding columns without forking.
