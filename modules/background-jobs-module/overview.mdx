...
* EF Core declares an index on `(IsAbandoned, NextTryTime)` — the MongoDB provider declares no indexes (see [MongoDB provider](/modules/background-jobs-module/mongodb)).
...
* [Domain layer](/modules/background-jobs-module/domain) — entity properties, store mapping, AutoMapper profile.
* [EF Core provider](/modules/background-jobs-module/efcore) — schema, indexes, query plan.
* [MongoDB provider](/modules/background-jobs-module/mongodb) — collection, document shape, indexing recommendations.
