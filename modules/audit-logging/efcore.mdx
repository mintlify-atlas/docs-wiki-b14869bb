...
* [Domain layer](./domain) — the aggregates and the converter.
* [MongoDB provider](./mongodb) — same `IAuditLogRepository`, different physical shape.
* [Framework / Auditing](/framework/cross/auditing) — the capture pipeline.
* [Object extensions](/framework/infrastructure/object-extensions) — how `b.ApplyObjectExtensionMappings()` translates your extra properties to columns.
