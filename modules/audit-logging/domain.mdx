...
* [Audit Logging EF Core provider](./efcore) — DbContext, indexes, query shapes.
* [Audit Logging MongoDB provider](./mongodb) — single collection, embedded documents.
* [Framework / Auditing](/framework/cross/auditing) — capture side (interceptors, `[Audited]`, `IAuditingManager`).
* [Framework / Object extensions](/framework/infrastructure/object-extensions) — extending `AuditLog` without forking.
