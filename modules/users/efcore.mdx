...
* [Overview](./overview) — package map.
* [Domain](./domain) — `IUser`, `IUserRepository<>`, `UserLookupService<,>`.
* [MongoDB base classes](./mongodb) — equivalent repository over MongoDB.
* [Identity EF Core](/modules/identity/efcore) — concrete `EfCoreIdentityUserRepository` derives from this base.
* [Object extensions](/framework/infrastructure/object-extensions) — `ApplyObjectExtensionMappings` follow-up.
