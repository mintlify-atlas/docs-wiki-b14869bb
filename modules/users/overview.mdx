...
* [Users Abstractions package](/modules/users/abstractions) — `IUserData`, `UserEto`, `IExternalUserLookupServiceProvider`.
* [Users Domain package](/modules/users/domain) — `IUser`, `IUserRepository<>`, `UserLookupService<,>`.
* [Users EF Core base classes](/modules/users/efcore) — `EfCoreUserRepositoryBase`, `ConfigureAbpUser`.
* [Users MongoDB base classes](/modules/users/mongodb) — `MongoUserRepositoryBase`.
