...
* [Overview](/modules/users/overview) — package map and pipeline.
* [Abstractions](/modules/users/abstractions) — `IUserData`, `UserEto`, `IExternalUserLookupServiceProvider`.
* [EF Core base classes](/modules/users/efcore) — `EfCoreUserRepositoryBase`, `ConfigureAbpUser`.
* [MongoDB base classes](/modules/users/mongodb) — `MongoUserRepositoryBase`.
